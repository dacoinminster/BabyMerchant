...
const STROKE = '#000';
const FILL = '#fff';
const TRANSITION_DEFAULT_MS = 12000;
const TRANSITION_L0_L1_MS = 12000; // 12s total for level 0<->1 zooms
...
const TRANSITION_L1_L2_MS = TRANSITION_L0_L1_MS; // keep in sync (12s)
